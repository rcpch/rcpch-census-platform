...
class PopulationDensity(models.Model):
    ...
    ruc11 = models.CharField(max_length=2, blank=True, null=True)
    ...
    popn_children_close2home = models.IntegerField(blank=True, null=True)
    popn_olderpeople_close2home = models.IntegerField(blank=True, null=True)
