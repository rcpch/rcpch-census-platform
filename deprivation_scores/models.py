...
class PopulationDensity(models.Model):
    ...
    buff200_popdens_deficit = models.CharField(blank=True, null=True, max_length=50)
    buff300_popdens_deficit = models.CharField(blank=True, null=True, max_length=50)
    buff1k_popdens_deficit = models.CharField(blank=True, null=True, max_length=50)
    buff2k_popdens_deficit = models.CharField(blank=True, null=True, max_length=50)
    buff5k_popdens_deficit = models.CharField(blank=True, null=True, max_length=50)
    buff10k_popdens_deficit = models.CharField(blank=True, null=True, max_length=50)
    buff200_imd_deficit = models.CharField(blank=True, null=True, max_length=50)
    buff300_imd_deficit = models.CharField(blank=True, null=True, max_length=50)
    buff1k_imd_deficit = models.CharField(blank=True, null=True, max_length=50)
    buff2k_imd_deficit = models.CharField(blank=True, null=True, max_length=50)
    buff5k_imd_deficit = models.CharField(blank=True, null=True, max_length=50)
    buff10k_imd_deficit = models.CharField(blank=True, null=True, max_length=50)
    ag_area_ha = models.FloatField(blank=True, null=True)
    index_multiple_deprivation_2019 = models.FloatField(blank=True, null=True)
    population_estimate2018 = models.IntegerField(blank=True, null=True)
    population_growth_2011_2018 = models.FloatField(blank=True, null=True)
    ...
    ruc_category = models.CharField(max_length=80, blank=True, null=True)
    ruc11 = models.CharField(max_length=50, blank=True, null=True)
    lnr_area_ha = models.FloatField(blank=True, null=True)
    residentialaddress_count = models.IntegerField(blank=True, null=True)
    ...
    popn_close2home = models.FloatField(blank=True, null=True)
    ...
    popn_children_close2home = models.FloatField(blank=True, null=True)
    popn_olderpeople_close2home = models.FloatField(blank=True, null=True)
