...
def seed_data_fixture(django_db_setup, django_db_blocker):
    with django_db_blocker.unblock():
        ...
        EnglishIndexMultipleDeprivation = apps.get_model("deprivation_scores", "EnglishIndexMultipleDeprivation")
        WelshIndexMultipleDeprivation = apps.get_model("deprivation_scores", "WelshIndexMultipleDeprivation")
