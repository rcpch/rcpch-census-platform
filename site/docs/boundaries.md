...
| **Guernsey**                      | 2024 | [geoBoundaries ADM0](https://github.com/wmgeolab/geoBoundaries/raw/9469f09/releaseData/gbOpen/GGY/ADM0/geoBoundaries-GGY-ADM0.geojson)                                                       | `shapeISO`      | `code`                          |
| **Isle of Man**                   | 2024 | [geoBoundaries ADM0](https://github.com/wmgeolab/geoBoundaries/raw/9469f09/releaseData/gbOpen/IMN/ADM0/geoBoundaries-IMN-ADM0.geojson)                                                       | `shapeISO`      | `code`                          |
| **Jersey**                        | 2024 | [GADM v4.1 ADM0](https://geodata.ucdavis.edu/gadm/gadm4.1/json/gadm41_JEY_0.json)                                                                                                            | `GID_0`         | `code`                          |
...
- `nation`: `england`, `wales`, `scotland`, `northern_ireland`, or `channel_islands`
- `year`: Boundary year
...
Crown Dependency boundaries are exposed through zoom-banded tables:

- `public.channel_islands_tiles_z0_4` (high simplification, 1500 m)
- `public.channel_islands_tiles_z5_7` (medium simplification, 200 m)
- `public.channel_islands_tiles_z8_10` (fine simplification, 60 m)
- `public.channel_islands_tiles_z11_14` (raw geometry — full detail)
- `public.channel_islands_tiles` (view alias → z11_14)

Each exposes:

- `code` (ISO 3166-1 alpha-3: `GGY`, `IMN`, `JEY`)
- `area_name` (territory name)
- `nation` (`channel_islands`)
- `year` (2024)
...
curl http://localhost:7800/public.channel_islands_tiles.json | jq '.properties[] | .name'
```
